...
export type StarshipsQueryVariables = Exact<{ [key: string]: never; }>;
...
/**
 * __useStarshipsQuery__
 *
 * To run a query within a React component, call `useStarshipsQuery` and pass it any options that fit your needs.
 * When your component renders, `useStarshipsQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useStarshipsQuery({
 *   variables: {
 *   },
 * });
 */
export function useStarshipsQuery(baseOptions?: Apollo.QueryHookOptions<StarshipsQuery, StarshipsQueryVariables>) {
        return Apollo.useQuery<StarshipsQuery, StarshipsQueryVariables>(StarshipsDocument, baseOptions);
      }
export function useStarshipsLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<StarshipsQuery, StarshipsQueryVariables>) {
          return Apollo.useLazyQuery<StarshipsQuery, StarshipsQueryVariables>(StarshipsDocument, baseOptions);
        }
export type StarshipsQueryHookResult = ReturnType<typeof useStarshipsQuery>;
export type StarshipsLazyQueryHookResult = ReturnType<typeof useStarshipsLazyQuery>;
export type StarshipsQueryResult = Apollo.QueryResult<StarshipsQuery, StarshipsQueryVariables>;